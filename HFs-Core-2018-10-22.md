...
### Solution
1. Deploy [new smart contracts](https://github.com/poanetwork/poa-network-consensus-contracts/tree/e6e04e926e3b44a2e48a897c03225726a241537f) and migrate all the data from old to new contracts with [`scripts/migrate/migrateAll.js`](https://github.com/poanetwork/poa-network-consensus-contracts/tree/e6e04e926e3b44a2e48a897c03225726a241537f/scripts/migrate/migrateAll.js).
...
- add `blockRewardContractAddress` (obtained from step 1) and `blockRewardContractTransition` (equal to `5783200` - `November 17th, 2018`) to `engine/authorityRound/params`.
5. Organize the HF on block `5337460`.
