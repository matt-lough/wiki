...
- Smart contracts need to be checked for security and design issues ([audit report by MixBytes team](https://github.com/poanetwork/poa-network-consensus-contracts/blob/a9f63b19e5e4f0f238211d0cd8c456ad384d4a6c/audit/MixBytes/PoA%20Consensus%20Audit.pdf)).
- Minor bugs.
...
### Solution
1. Deploy new smart contracts and migrate all the data from old to new contracts with [`scripts/migrate/migrateAll.js`](https://github.com/poanetwork/poa-network-consensus-contracts/blob/6c2c7798394ed14abcfb53fe9ce6269cd83630ff/scripts/migrate/migrateAll.js).
